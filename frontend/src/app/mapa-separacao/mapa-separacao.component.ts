 ...
 * quebra por nota (economia de papel): seco/refrigerado não pesáveis saem
 * somados na OC inteira (uma folha por categoria); pesáveis e congelados
 * ficam segregados por cliente. Pesável leva ícone de balança. Identidade visual do WMS (tokens de
