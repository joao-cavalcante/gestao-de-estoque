...
@Component({
  selector: 'oq-aba-formacao-volumes',
  standalone: true,
  imports: [OqConfigSecaoComponent, OqConfigCampoRowComponent],
  templateUrl: './oq-aba-formacao-volumes.component.html',
})
export class OqAbaFormacaoVolumesComponent {
  ...
  private readonly catalogoAba = CATALOGO_CONFIG_CONFERENCIA.filter((c) => c.aba === 'volumes');
